...
import 'bloc/online_designs_bloc.dart';
...
class OnlineDesignsScreen extends StatelessWidget {
  const OnlineDesignsScreen({Key? key}) : super(key: key);

  Widget builder(BuildContext context) {
    return BlocProvider<OnlineDesignsBloc>(
      create: (context) => OnlineDesignsBloc(
        OnlineDesignsState(shapesModelObj: OnlineDesignsModel()),
      )..add(OnlineDesignsInitialEvent()),
      child: const OnlineDesignsScreen(),
    );
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title: BlocSelector<OnlineDesignsBloc, OnlineDesignsState,
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(left: 2.h),
            child: BlocSelector<OnlineDesignsBloc, OnlineDesignsState,
                OnlineDesignsModel?>(
              ...
              builder: (context, shapesModelObj) {
                return GridView.builder(
                  ...
                  itemCount: shapesModelObj?.userprofileItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    UserprofileItemModel model =
                        shapesModelObj?.userprofileItemList[index] ??
