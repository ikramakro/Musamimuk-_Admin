...
import 'bloc/add_logos_bloc.dart';
import 'bloc/add_logos_state.dart';
import 'models/add_logos_model.dart';

class AddLogosScreen extends StatelessWidget {
  AddLogosScreen({super.key});
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  static Widget builder(BuildContext context) {
    return BlocProvider<AddLogosBloc>(
      create: (context) => AddLogosBloc(AddLogosState(
        addLogosModelObj: AddLogosModel(),
      ))
        ..add(AddLogosInitialEvent()),
      child: AddLogosScreen(),
    );
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title: BlocSelector<AddLogosBloc, AddLogosState, TextEditingController?>(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                BlocSelector<AddLogosBloc, AddLogosState,
                ...
                SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      BlocSelector<AddLogosBloc, AddLogosState, AddLogosModel?>(
                        selector: (state) => state.addLogosModelObj,
                        builder: (context, addLogosModelObj) {
                          return CustomDropDown(
                            onChanged: (value) {},
                            items: addLogosModelObj?.dropdownItemList ?? [],
                          );
                        },
                      )
                    ],
                    ...
                    children: [
                      ...
                      BlocSelector<AddLogosBloc, AddLogosState, AddLogosModel?>(
                        ...
                        builder: (context, addLogosModelObj) {
                          return CustomDropDown(
                            onChanged: (value) {},
                            items: addLogosModelObj?.dropdownItemList1 ?? [],
                          );
                        },
                      )
                    ],
  ...
  void _onAddLogoEventSuccess(BuildContext context) {
    ...
    //     msg: context.read<AddLogosBloc>().postAddLogoResp.message.toString() ??
    //         '');
  }
