...
import 'bloc/start_a_new_contest_bloc.dart';
import 'models/start_a_new_contest_model.dart';

// ignore_for_file: must_be_immutable
class StartANewContestScreen extends StatelessWidget {
  StartANewContestScreen({super.key});

  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  static Widget builder(BuildContext context) {
    return BlocProvider<StartANewContestBloc>(
      create: (context) => StartANewContestBloc(StartANewContestState(
        startANewContestModelObj: StartANewContestModel(),
      ))
        ..add(StartANewContestInitialEvent()),
      child: StartANewContestScreen(),
    );
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title: BlocSelector<StartANewContestBloc, StartANewContestState,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                BlocSelector<StartANewContestBloc, StartANewContestState,
                    TextEditingController?>(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      BlocSelector<StartANewContestBloc, StartANewContestState,
                        ...
                        selector: (state) => state.startANewContestModelObj,
                        builder: (context, startANewContestModelObj) {
                          return CustomDropDown(
                            onChanged: (value) {},
                            items: startANewContestModelObj?.dropdownItemList ??
                                [],
                          );
                        },
                      )
                      ...
                      BlocSelector<StartANewContestBloc, StartANewContestState,
                        ...
                        builder: (context, startANewContestModelObj) {
                          return CustomDropDown(
                            onChanged: (value) {},
                            items:
                                startANewContestModelObj?.dropdownItemList1 ??
                                    [],
                          );
                        },
                      )
  ...
  /// Calls the https://api.pixlerpro.com/api/logo/add API and triggers a [CreateAddEvent] event on the [StartANewContestBloc] bloc.
  ///
  /// The [BuildContext] parameter represents current [BuildContext]
  onTapSave(BuildContext context) {
    context.read<StartANewContestBloc>().add(
          CreateAddEvent(
