...
import 'bloc/png_images_bloc.dart';
...
class PngImagesScreen extends StatelessWidget {
  const PngImagesScreen({Key? key}) : super(key: key);

  Widget builder(BuildContext context) {
    return BlocProvider<PngImagesBloc>(
      create: (context) => PngImagesBloc(
        PngImagesState(shapesModelObj: PngImagesModel()),
      )..add(PngImagesInitialEvent()),
      child: const PngImagesScreen(),
    );
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title:
          BlocSelector<PngImagesBloc, PngImagesState, TextEditingController?>(
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(left: 2.h),
            child: BlocSelector<PngImagesBloc, PngImagesState, PngImagesModel?>(
