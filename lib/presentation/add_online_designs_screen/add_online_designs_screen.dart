...
import 'bloc/add_online_designs_bloc.dart';
import 'models/add_online_designs_model.dart';

class AddOnlineDesignsScreen extends StatelessWidget {
  AddOnlineDesignsScreen({super.key});
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  static Widget builder(BuildContext context) {
    return BlocProvider<AddOnlineDesignsBloc>(
      create: (context) => AddOnlineDesignsBloc(AddOnlineDesignsState(
        addOnlineDesignsModelObj: AddOnlineDesignsModel(),
      ))
        ..add(AddOnlineDesignsInitialEvent()),
      child: AddOnlineDesignsScreen(),
    );
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title: BlocSelector<AddOnlineDesignsBloc, AddOnlineDesignsState,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                BlocSelector<AddOnlineDesignsBloc, AddOnlineDesignsState,
                    TextEditingController?>(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      BlocSelector<AddOnlineDesignsBloc, AddOnlineDesignsState,
                        ...
                        selector: (state) => state.addOnlineDesignsModelObj,
                        builder: (context, addOnlineDesignsModelObj) {
                          return CustomDropDown(
                            onChanged: (value) {},
                            items: addOnlineDesignsModelObj?.dropdownItemList ??
                                [],
                          );
                        },
                      )
                      ...
                      BlocSelector<AddOnlineDesignsBloc, AddOnlineDesignsState,
                        ...
                        builder: (context, addOnlineDesignsModelObj) {
                          return CustomDropDown(
                            onChanged: (value) {},
                            items:
                                addOnlineDesignsModelObj?.dropdownItemList1 ??
                                    [],
                          );
                        },
                      )
  ...
  onTapSave(BuildContext context) {
    context.read<AddOnlineDesignsBloc>().add(
          CreateAddEvent(
