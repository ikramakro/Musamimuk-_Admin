...
import 'bloc/logos_bloc.dart';
import 'models/logos_model.dart';
...
class LogosScreen extends StatelessWidget {
  ...
  Widget builder(BuildContext context) {
    return BlocProvider<LogosBloc>(
      create: (context) => LogosBloc(
        LogosState(shapesModelObj: LogosModel()),
      )..add(LogosInitialEvent()),
      child: const LogosScreen(),
    );
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title: BlocSelector<LogosBloc, LogosState, TextEditingController?>(
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(left: 2.h),
            child: BlocSelector<LogosBloc, LogosState, LogosModel?>(
